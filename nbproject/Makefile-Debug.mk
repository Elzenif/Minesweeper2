...
${OBJECTDIR}/src/gameDisplay/main.o: src/gameDisplay/main.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gameDisplay/main.o src/gameDisplay/main.cpp

${OBJECTDIR}/src/gameGrid/AbstractCell.o: src/gameGrid/AbstractCell.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gameGrid
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gameGrid/AbstractCell.o src/gameGrid/AbstractCell.cpp

${OBJECTDIR}/src/gameGrid/AbstractGrid.o: src/gameGrid/AbstractGrid.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/gameGrid
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/gameGrid/AbstractGrid.o src/gameGrid/AbstractGrid.cpp
